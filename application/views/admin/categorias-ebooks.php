...
<div class="container">
  ...
  <div class="buttons-container">
    <a href="/admin/categorias-ebooks/new" class="buttons btn-primary" href="#"><img src="<?php echo base_url() ?>resources/images/admin/plus.png"/>Nuevo</a>
  ...
  <div class="list">
    <table>
      ...
      <tr class="table-content">
        ...
        <td>
          <a href="/admin/categorias-ebooks/<?php echo $ebook->id;?>" class="simptip-position-top simptip-fade" data-tooltip="Editar"><img src="<?php echo base_url() ?>resources/images/admin/edit.png" alt="Editar" /></a>
          <form method="POST" action="/admin/categorias-ebooks/delete" class="list-inline">
