...
<div class="main-content top100">
	<div class="container">
		<h1 class="title-section">Recursos de Información</h1>
		<hr class="title-line" />
	</div>
	...
	<div class="container small">
		...
		<a href="/catalogos" class="btn-link">
			...
			<label for="">Otros Catálogos</label>
			</div>
		</a>
		<a href="/base_datos" class="btn-link">
			<div class="btn-content">
			<div class="icon-link" id="datos">
				<img src="<?php echo $images_folder ?>icons/icon-datos.png" />
			</div>
